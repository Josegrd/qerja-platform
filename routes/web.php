...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:apply job')->group(function () {
       ...
       Route::get('/dashboard/proposal_details/{project}/{projectApplicant}', [DashboardController::class, 'project_details'])
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/wallet/withdraws', [WalletTransactionController::class,'wallet_withdrawals'])
        ->name('withdrawals');
    ...
    Route::middleware('can:manage projects')->group(function () {
       ...
       Route::get('/project/{projectApplicant}/completed', [ProjectController::class, 'complete_project_store'])
